...
# global_variables.fight_started = False
# global_variables.boss_fight = False
fight_timer_start = 0
...
def updateStatus(status):
    ...
    # global_variables.fight_started, fight_timer_start
    # global_variables.boss_fight boss_fight
    ...
    if log_len > 0:
        ...
        for line in logs.log:
            ...
            if match_obj is not None:
                ...
                if tag == 'LETTUCE_BOUNTY_BOSS': global_variables.boss_fight = True
        ...
        #         LOG_LINE_SHOW_ENTITY,
            ...
            if "CREATE_GAME" in line_str:
                global_variables.fight_started = True
                global_variables.boss_fight = False
            ...
            #     if boss in line_str:
            #         # print('line=%s' % line)
                # global_variables.boss_fight = True
    ...
    # global_variables.# print('[fight_started=%s]' % str(fight_started))
    # global_variables.boss_fight print('[boss_fight=%s]' % str(boss_fight))
    return status
...
# #     # global_variables.global fight_started

# #     bounty_button = [450, 350]
# #     confirm_team_button = [840, 625]

# #     counter = 0
# #     # global_variables.while not fight_started:
# #         global_variables.# print('fight status= %s' % (str(fight_started)))
# #         click(select_team_button)
...
# #     global_variables.global fight_started, fight_timer_start
...
# #     counter = 0
# #     global_variables.while fight_started:
...
# #         global_variables.if not fight_started: 
...
#             global_variables.if fight_started:
#                 fight_stage(status)
#                 status = updateStatus(status)
#                 time.sleep(5)
            
#             global_variables.boss_fight boss_fight: break
#             on_map()
#             status = updateStatus(status)
